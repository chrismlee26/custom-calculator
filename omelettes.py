...
print("3. Stir into a circular pattern while eggs begin to form. Continually lift sides of eggs and shake the pan for allow uncooked eggs and butter to form under the egg that has already set. You will need more movement than you think, but not so much that nothing happens :)")
